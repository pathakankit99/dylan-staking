...
const data01 = [
  { value: 50, fill: "#66fcf2" },
  { value: 50, fill: "#eeeeee" },
];

const data02 = [
  { value: 60, fill: "#66fcf2" },
    ...
    <div className="w-full lg:w-6/12 lg:pl-3 relative mt-3 lg:m-0">
      <div className="bg-brand_accent p-6  lg:h-50vh rounded">
        ...
        <div className="flex flex-wrap">
          <div className="pb-6 lg:pb-0 chart-1  w-full md:w-6/12 p-3 text-center">
            <div className="bg-brand_bg py-1 rounded-xl">
              ...
              <div className="info pt-4 text-gray-100">
                <p className="text-3xl text-brand_tertiary">0%</p>
                <p className="text-gray-100">My NFTs Staked</p>
              </div>
            </div>
          </div>
          <div className="chart-2 w-full md:w-6/12 p-3 text-center">
            <div className="bg-brand_bg py-1 rounded-xl">
              <div className="center relative">
                <PieChart height={120} width={120}>
                  <Pie
              ...
              <div className="info pt-4 text-gray-100">
                <p className="text-3xl" style={{ color: "#66fcf2" }}>
                  60%
                </p>
        ...
        <div className="center">
          <div className="text-center">
            <p className="uppercase text-white font-medium tracking-wider pt-3 text-xl">
              0 Sol /Day
            </p>
